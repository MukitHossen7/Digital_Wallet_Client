        ...
        <div className="max-h-[75vh] overflow-y-auto px-6 py-6 custom-scrollbar">
          ...
          >
            ...
            <DialogFooter className="flex flex-col sm:flex-row gap-3 pt-4">
              ...
              <Button
                type="submit"
                className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-white font-black uppercase tracking-widest text-xs h-10 px-10 rounded-lg shadow-none shadow-primary/20 active:scale-95 transition-all flex items-center gap-2"
              >
